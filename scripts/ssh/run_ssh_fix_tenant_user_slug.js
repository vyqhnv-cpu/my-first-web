...
conn.on('ready', () => {
  ...
  const commands = `
    ...
    docker compose -f docker-compose.yml -f docker-compose.postgres.yml exec -T postgres psql -U goclaw -d goclaw -c "INSERT INTO tenants (id, name, slug, created_at, updated_at) VALUES ('00000000-0000-0000-0000-000000000001', 'Admin Tenant', 'admin-tenant', NOW(), NOW()) ON CONFLICT (id) DO NOTHING;"
